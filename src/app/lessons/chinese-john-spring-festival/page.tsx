  ...
  return (
    <div className="bg-neutral-50 px-4 py-12 text-slate-900">
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        <section className="rounded-3xl border border-slate-200 bg-slate-900 p-6 text-slate-100">
          <p className="text-sm uppercase tracking-[0.4em] text-rose-300">ERAP prompts</p>
          <div className="mt-3 grid gap-4 md:grid-cols-2">
            <article className="rounded-2xl bg-slate-800/60 p-4">
              <h3 className="text-lg font-semibold">Explain</h3>
              <p className="text-sm text-slate-300">
                用中文解释 “年年有余” 的意思，并说说为什么春节一定要有鱼。
              </p>
            </article>
            <article className="rounded-2xl bg-slate-800/60 p-4">
